  ...
  return (
    <div>
      <h2 id="category-heading">
        <Translate contentKey="zitechApp.category.home.title">Categories</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="zitechApp.category.home.createLabel">Create new Category</Translate>
        </Link>
      </h2>
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="zitechApp.category.categoryName">Category Name</Translate>
                </th>
                <th> Sub </th>
                <th />
              </tr>
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="zitechApp.category.home.notFound">No Categories found</Translate>
              </div>
            )
          )}
      </div>
